    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-20">
        <div className="animate-fade-up">
          <div className="mb-8">
            <div className="w-32 h-32 mx-auto mb-8 rounded-full bg-gradient-to-r from-electric-blue via-neon-purple to-neon-cyan p-1 animate-float relative">
              ...
              <div className="absolute inset-0 rounded-full bg-gradient-to-r from-electric-blue via-neon-purple to-neon-cyan opacity-30 blur-md animate-pulse"></div>
            </div>
          </div>
          ...
          <p className="text-lg sm:text-xl text-white/70 max-w-3xl mx-auto mb-12 leading-relaxed drop-shadow-lg">
            As a full-stack JavaScript developer, I specialize in creating
            high-performance websites and apps using Next.js, React, Node.js,
            Express, and MongoDB — with a strong focus on smooth UI/UX
            animations that elevate user engagement. Whether it's a dynamic
            frontend interface or a robust backend system, I deliver clean,
            secure, and maintainable code optimized for speed and
            responsiveness.
          </p>
          ...
          <div className="flex justify-center space-x-6 mb-16">
            <a
              href="https://github.com/sumonsnote"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/sumonsnote/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/70 hover:text-electric-blue transition-colors p-3 rounded-full bg-black/20 backdrop-blur-sm border border-white/10 hover:border-electric-blue/50 hover:scale-110 transform duration-300 drop-shadow-xl"
            >
            ...
            <a
              href="mailto:sumon@sumonsnote.com"
              className="text-white/70 hover:text-electric-blue transition-colors p-3 rounded-full bg-black/20 backdrop-blur-sm border border-white/10 hover:border-electric-blue/50 hover:scale-110 transform duration-300 drop-shadow-xl"
            >
              <Mail size={24} />
            </a>
        ...
        <button
          ...
          className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-electric-blue animate-bounce p-2 rounded-full bg-black/20 backdrop-blur-sm border border-white/10 hover:border-electric-blue/50 transition-all duration-300"
        >
          <ChevronDown size={32} />
        </button>
      </div>
