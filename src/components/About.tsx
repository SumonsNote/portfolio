        ...
        <div className="scroll-animate opacity-0">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                I thrive on challenges and continuously learn new technologies to stay at the
                forefront of web development. Whether it's architecting complex systems or crafting
                pixel-perfect interfaces, I bring dedication and expertise to every project.
              </p>
